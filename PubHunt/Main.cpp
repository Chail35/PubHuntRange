...
void printUsage() {
    ...
    printf("        [-o outputfile] [-sr startRange] [-er endRange] [inputFile]\n\n");
...
int main(int argc, const char* argv[])
{
    ...
    while (a < argc) {
        ...
        else if (strcmp(argv[a], "-sr") == 0) {
            a++;
            startRange = strtoull(argv[a], nullptr, 16);
            a++;
        }
        else if (strcmp(argv[a], "-er") == 0) {
            a++;
            endRange = strtoull(argv[a], nullptr, 16);
            a++;
        }
